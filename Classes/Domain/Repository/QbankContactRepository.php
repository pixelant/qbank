...
use Pixelant\Qbank\Repository\Traits\LimitResultTrait;
use TYPO3\CMS\Core\Utility\GeneralUtility;

/**
 * Repository for manipulating contact data via the Qbank API.
 */
class QbankContactRepository extends AbstractHubspotRepository
{
     ...
     */
    public function update(int $identifier, array $properties): void
    {
